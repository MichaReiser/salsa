...
## [0.20.0](https://github.com/MichaReiser/salsa/compare/salsa-v0.19.0...salsa-v0.20.0) - 2025-04-11
...
- Dereferencing freed memos when verifying provisional memos ([#788](https://github.com/MichaReiser/salsa/pull/788))
- `#[doc(hidden)]` `plumbing` module ([#781](https://github.com/MichaReiser/salsa/pull/781))
- Use `changed_at` revision when updating fields ([#778](https://github.com/MichaReiser/salsa/pull/778))

### Other

- [refactor] Simplify `fetch_hot` ([#792](https://github.com/MichaReiser/salsa/pull/792))
- [refactor] Reuse the same stack for all cycles heads in `validate_same_iteration` ([#791](https://github.com/MichaReiser/salsa/pull/791))
- add WillIterateCycle event ([#790](https://github.com/MichaReiser/salsa/pull/790))
- [fix] Use `validate_maybe_provisional` instead of `validate_provisional` ([#789](https://github.com/MichaReiser/salsa/pull/789))
- Use `ThinVec` for `CycleHeads` ([#787](https://github.com/MichaReiser/salsa/pull/787))
- Keep edge condvar on stack instead of allocating it in an `Arc` ([#773](https://github.com/MichaReiser/salsa/pull/773))
- allow reuse of cached provisional memos within the same cycle iteration ([#786](https://github.com/MichaReiser/salsa/pull/786))
- Implement `Lookup`/`HashEqLike` for `Arc` ([#784](https://github.com/MichaReiser/salsa/pull/784))
- Normalize imports style ([#779](https://github.com/MichaReiser/salsa/pull/779))
- Clean up `par_map` a bit ([#742](https://github.com/MichaReiser/salsa/pull/742))
- Fix typo in comment ([#777](https://github.com/MichaReiser/salsa/pull/777))
- Document most safety blocks ([#776](https://github.com/MichaReiser/salsa/pull/776))
- Use html directory for mdbook artifact ([#774](https://github.com/MichaReiser/salsa/pull/774))
- Move `verified_final` from `Memo` into `QueryRevisions` ([#769](https://github.com/MichaReiser/salsa/pull/769))
- Use `ThinVec` for `MemoTable`, halving its size ([#770](https://github.com/MichaReiser/salsa/pull/770))
- Remove unnecessary query stack acess in `block_on` ([#771](https://github.com/MichaReiser/salsa/pull/771))
- Replace memo queue with append-only vector ([#767](https://github.com/MichaReiser/salsa/pull/767))
- update boxcar ([#696](https://github.com/MichaReiser/salsa/pull/696))
- Remove extra page indirection in `Table` ([#710](https://github.com/MichaReiser/salsa/pull/710))
- update release steps ([#705](https://github.com/MichaReiser/salsa/pull/705))
