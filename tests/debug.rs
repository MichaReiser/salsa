...
fn input() {
    salsa::DatabaseImpl::new().attach(|db| {
        ...
        let expected = expect![[r#"Input(Id(400), ComplexStruct { my_input: Input(Id(0), MyInput { field: 22 }), not_salsa: NotSalsa { field: "it's salsa time" } })"#]];
...
fn custom_debug_impl() {
    ...
    expect![[r#"
        "Input(Id(0), MyInput { field: 22 }) / 23"
    "#]]
    .assert_debug_eq(&s);
}
